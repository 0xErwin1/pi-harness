...
export const REQUIRED_RUNTIME_SURFACE = [
  ...
  { path: "vendor/rpiv-ask-user-question", kind: "dir" },
  { path: "vendor/rpiv-ask-user-question/index.ts", kind: "file" },
  { path: "vendor/rpiv-ask-user-question/README.md", kind: "file" },
